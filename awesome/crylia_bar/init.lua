...
-- e.g. 1 would be the primary screen and 2 the secondary screen.
  ...
  if s.index == 1 then
    ...
    s.ram_usage = require("src.widgets.ram_info")()
    ...
    require("crylia_bar.right_bar")(s, {s.cpu_usage, s.ram_usage,  s.cpu_temp,  s.network, s.audio, s.kblayout, s.date, s.clock, s.powerbutton})
  ...
  if s.index == 2 then
    ...
    require("crylia_bar.center_bar")(s, { s.tasklist })
    require("crylia_bar.right_bar")(s, { s.ram_info, s.audio, s.kblayout, s.date, s.clock, s.powerbutton, s.bluetooth })
  end
